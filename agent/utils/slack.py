...
async def post_slack_thread_reply(channel_id: str, thread_ts: str, text: str) -> str | None:
    """Post a reply in a Slack thread. Returns the message_ts on success."""
    if not SLACK_BOT_TOKEN:
        return None
...
async def post_slack_trace_reply(channel_id: str, thread_ts: str, run_id: str) -> str | None:
    """Post a trace URL reply in a Slack thread. Returns the message_ts."""
